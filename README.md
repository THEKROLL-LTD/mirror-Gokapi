...
- **Context and rationale:** *[Stop Pulling Random Docker Images](https://medium.com/@sventhekroll/stop-pulling-random-docker-images-c19e94559cc6)* — the post that describes this pipeline and why we run it